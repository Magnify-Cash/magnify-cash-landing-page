...
const Hero = () => {
  return (
    <section className="relative overflow-hidden px-6 lg:px-8 py-24 sm:py-32">
      <div className="absolute inset-0 bg-gradient-to-r from-[#ee9ca7] to-[#ffdde1] opacity-20 animate-gradient" />
      ...
      <div className="mx-auto max-w-7xl text-center relative">
        <div className="animate-fade-in [animation-delay:200ms]">
          <a
            ...
            className="inline-flex items-center rounded-full px-4 py-1 text-sm font-medium bg-[#ee9ca7]/10 text-[#ee9ca7] mb-6 animate-fade-in hover:bg-[#ee9ca7]/20 transition-colors"
          >
          ...
          <h1 className="text-display font-bold tracking-tight text-primary mb-6">
            ...
            <br />
            <span className="bg-gradient-to-r from-[#ee9ca7] to-[#ffdde1] bg-clip-text text-transparent animate-gradient">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in [animation-delay:600ms]">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group px-8 py-4 bg-gradient-to-r from-[#ee9ca7] to-[#ffdde1] text-white rounded-full font-semibold hover:opacity-90 transition-all hover:scale-105 flex items-center justify-center gap-2 relative overflow-hidden"
            >
              <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-[#ee9ca7] to-[#ffdde1] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
          ...
          <div className="mt-6 flex items-center justify-center gap-8 animate-fade-in [animation-delay:800ms]">
            <p className="text-small text-muted flex items-center gap-2">
              <span className="inline-block w-2 h-2 rounded-full bg-[#ee9ca7] animate-pulse"></span>
